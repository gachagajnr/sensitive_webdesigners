		...
		<div class="  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-center">
			<div class="p-6">
				<div class="ml-2 py-2 text-xl">
					...
					have a question about our services, want to discuss a potential project, or simply want to
				...
				<div class="ml-2 grid">
					...
					<p class="ml-2 font-thin join gap-2">
						...
						<span class="join-item"> Personalized Attention </span>
					</p>
					<p class="ml-2 font-thin join gap-2">
						<svg
							class="w-6 h-6 text-primary   join-item"
						...
						<span class="join-item"> Expert Advice </span>
					</p>
					<p class="ml-2 font-thin join gap-2">
						<svg
							class="w-6 h-6 text-primary   join-item"
